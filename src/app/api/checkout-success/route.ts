...
import { LogoExporter, ExportOptions } from '@/lib/exportUtils';
...
// Initialize Stripe with basil API version
...
async function generateLogoFiles(
  ...
  if (packageId === 'premium') {
    // Since SVG export is not directly supported, we'll use a high-quality PNG as a fallback
